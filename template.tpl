...

{
  ...
  "description": "This is the fork of the official Amplitude Analytics Browser SDK. See details here https://github.com/azrael/amplitude-browser-sdk-gtm-template",
  "containerContexts": [
    "WEB"
  ]
}
...
const onsuccess = () => {
  ...
  switch (data.type) {
    ...
    case 'track':
      ...
      // Support for the special "props" event property that will be parsed as a query from a URI.
      // E.g. "a=111&b=222" => { "a": "111", "b": "222" }
      // Each key from the parsed object will be added to the eventProperties
      if (eventProperties.props) {
        const props = eventProperties.props;
        Object.delete(eventProperties, 'props');
        props.split('&').forEach(prop => {
          const parts = prop.split('=');
          eventProperties[parts[0]] = parts[1];
        });
      }
